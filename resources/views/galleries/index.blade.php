	...
	<section class="container-fluid">
		<div class="row slider">
			<span class="col-sm-4">
				...
				<a href="/galleries/tags/{{ $tags[1]['name'] }}" class="slider-city">
					{{ $tags[1]['name'] }}
				</a>
			...
			<span class="col-sm-4" style="border-right: none; border-left: none">
				...
				<a href="/galleries/tags/{{ $tags[2]['name'] }}" class="slider-city">
					{{ $tags[2]['name'] }}
				</a>
			...
			<span class="col-sm-4">
				...
				<a href="/galleries/tags/{{ $tags[0]['name'] }}" class="slider-city">
					{{ $tags[0]['name'] }}
				</a>
